...
public class RoomTypeQualityProfile {
    ...
    public static final RoomTypeQualityProfile TERRARIUM = createTerrarium();
    ...
    private static RoomTypeQualityProfile createTerrarium() {
        RoomTypeQualityProfile profile = new RoomTypeQualityProfile(0.15f, 0.20f, 0.15f, 0.50f);
        profile.addThemeFactor("water", 2.0f);
        profile.addThemeFactor("frog_plant", 2.0f);
        profile.addThemeFactor("lily_pad", 1.8f);
        profile.addThemeFactor("seagrass", 1.8f);
        profile.addThemeFactor("kelp", 1.6f);
        profile.addThemeFactor("plant", 1.5f);
        profile.addThemeFactor("flower", 1.5f);
        profile.addThemeFactor("blue", 1.4f);
        profile.addThemeFactor("green", 1.3f);
        return profile;
    }
