...
public class Signals {
    ...
    static {
        PREDICATES.put("bed", s -> s.is(BEDS) || s.is(BlockTags.BEDS));
        ...
        PREDICATES.put("composter", s -> s.is(COMPOSTERS) || s.is(Blocks.COMPOSTER));
        ...
        PREDICATES.put("enchanting_table", s -> s.is(ENCHANTING_TABLES) || s.is(Blocks.ENCHANTING_TABLE));
        PREDICATES.put("fletching_table", s -> s.is(FLETCHING_TABLES) || s.is(Blocks.FLETCHING_TABLE));
        ...
        PREDICATES.put("stonecutter", s -> s.is(STONECUTTERS) || s.is(Blocks.STONECUTTER));
        PREDICATES.put("storage", s ->
                s.is(Tags.Blocks.CHESTS) || s.is(Tags.Blocks.BARRELS));
